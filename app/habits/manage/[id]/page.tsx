        ...
        <div className="flex gap-4 pt-4 pb-12">
          ...
          {currentStep === STEPS.length - 1 ? (
            <div className="flex-[2] flex justify-center">
              <SaveButton isSaving={saving} label="Update Habit" className="w-full max-w-xs h-12 bg-emerald-600 text-white rounded-xl font-black text-sm shadow-xl shadow-emerald-900/20 flex items-center justify-center gap-2 transition-all active:scale-[0.98] disabled:bg-muted" onClick={handleSave} />
            </div>
          ) : (
            <Button 
