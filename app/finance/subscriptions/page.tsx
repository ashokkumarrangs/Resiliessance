...
export default function SubscriptionsPage() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (tabParam === "paused") setActiveTab("Paused");
      else if (tabParam === "add") setActiveTab("Add Subscription");
  ...
  return (
    <PageWrapper
      ...
      activePath="/finance/subscriptions"
      headerActions={
        <button 
          onClick={fetchData}
      ...
      <div className="flex items-center justify-center relative mb-6 w-full">
        <SubNav 
          ...
          onChange={(val) => {
            ...
            if (typeof window !== "undefined") {
              const slug = val === "Paused" ? "paused" : val === "Add Subscription" ? "add" : "active";
              window.history.pushState({}, "", `/finance/subscriptions?tab=${slug}`);
            }
          }}
          className="!mb-0 !mx-0"
        />
