    ...
    >
        <div className="flex items-center justify-center relative mb-6 w-full">
          <SubNav 
            ...
            activeItem="Overview"
            onChange={(val) => {
              if (val === "Manage Accounts") router.push("/finance/accounts");
            }}
            className="!mb-0 !mx-0"
          />
        </div>
          ...
          <>
            {accounts.map((acc, i) => (
              ...
              >
                ...
                <Link
                  href={`/finance/accounts?name=${encodeURIComponent(acc.account_name)}`}
      ...
      {selectedAccount && (
        ...
        >
          ...
          >
            ...
            <Link 
              href={`/finance/accounts?name=${encodeURIComponent(selectedAccount.account_name)}`}
