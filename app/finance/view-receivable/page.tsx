...
export default function ViewReceivablePage() {
  ...
  return (
    <PageWrapper
      ...
      activePath="/finance/view-receivable"
      headerActions={
        <button 
    ...
    >
        ...
        <div className="flex items-center justify-center relative mb-6 w-full">
          <SubNav 
            ...
            onChange={(val) => {
              if (val === "Add Receivable") router.push("/finance/capital/receivables");
            }}
            className="!mb-0 !mx-0"
          />
        </div>
          ...
          >
            ...
            <div className="flex gap-4">
              <button 
                ...
                onClick={() => router.push(`/finance/capital/receivables?party=${encodeURIComponent(selectedReceivable.party)}`)}
              >
                Record Payment
              </button>
            </div>
