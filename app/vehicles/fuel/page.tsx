...
import { Calendar, CreditCard, Gauge, Clock, Droplets, Store } from "lucide-react";
...
export default function VehicleFuelServicePage() {
  return (
    <Suspense fallback={<div className="flex h-screen items-center justify-center font-black animate-pulse">LOADING FUEL LOG...</div>}>
